...
app.use('/bootstrap', express.static(appRoot + '/node_modules/bootstrap/dist/'));
app.use('/datetime', express.static(appRoot + '/node_modules/date-and-time/'));
app.use('/bstrap', express.static(appRoot + '/node_modules/date-and-time/'));
